export const Logo = () => (
  <svg
    viewBox="0 0 512 512"
    className="w-10 h-10 animate-spin-slow hover:animate-pulse transition-all duration-500"
  >
    <defs>
      <linearGradient id="logo-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" style={{ stopColor: '#0070F3' }} />
        <stop offset="100%" style={{ stopColor: '#00A6FF' }} />
      </linearGradient>
    </defs>
    <path
