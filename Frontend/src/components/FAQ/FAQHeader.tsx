...
const FAQHeader = () => {
  return (
    <header className="text-center py-12 sm:py-16 lg:py-20 rounded-xl">
      ...
      <p className="text-base sm:text-lg lg:text-xl text-gray-400 mb-2 max-w-3xl mx-auto leading-relaxed">
