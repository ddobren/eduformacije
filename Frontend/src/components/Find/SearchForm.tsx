          ...
          <div className="bg-gradient-to-b from-gray-900/80 to-gray-900/95 backdrop-blur-xl rounded-2xl border border-gray-800/50 shadow-2xl">
            ...
            <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
              ...
              <div className="space-y-2 sm:space-y-3">
                <label className="block text-sm font-medium text-white/90">Opiši svoje interese i želje</label>
                ...
                <p className="text-xs text-gray-400 leading-relaxed">
                  Što više detalja pružiš o svojim interesima i hobijima, to ćemo ti preciznije pomoći pronaći idealnu
                  školu.
                </p>
              </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                {isExpanded && (
                  <div className="space-y-3 sm:space-y-4 bg-gray-800/30 p-3 sm:p-4 rounded-lg animate-fadeIn">
                    <CountySelect value={selectedCounty} onChange={setSelectedCounty} onClear={handleClearCounty} />
                    <CitySelect
                      value={selectedCity}
                    ...
                    />
                    <EntranceExamSelect value={hasEntranceExam} onChange={setHasEntranceExam} />
                  </div>
                )}
              </div>
            </div>
