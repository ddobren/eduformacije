    ...
    <div ref={wrapperRef} className="relative w-full">
      ...
      <div className="relative">
        <button
          ...
          className="w-full px-4 py-2.5 text-left text-base bg-gray-900/50 border border-gray-800 rounded-lg 
        ...
        {isOpen && (
          <div className="absolute left-0 right-0 mt-1.5 bg-gray-900/95 backdrop-blur-sm border 
            ...
            {options.length > 0 ? (
              ...
              <div className="px-4 py-2.5 text-base text-gray-400">Nema opcija</div>
            )}
          </div>
        )}
      </div>
