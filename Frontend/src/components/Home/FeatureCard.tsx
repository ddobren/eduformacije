...
export const FeatureCard: React.FC<FeatureCardProps> = ({ Icon, title, description }) => {
  return (
    <motion.div
      className="group relative bg-gray-900/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-gray-800 hover:border-primary-500/50 transition-all duration-300 h-full overflow-hidden"
    ...
    >
      ...
      <div className="relative flex flex-col items-center text-center space-y-3 sm:space-y-4">
        <div className="bg-primary-500/10 rounded-xl p-3 sm:p-4 group-hover:bg-primary-500/20 transition-colors duration-300">
          <Icon className="w-6 h-6 sm:w-8 sm:h-8 text-primary-400 group-hover:text-primary-300 transition-colors duration-300" />
        </div>
