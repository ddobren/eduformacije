export const fetchCities = async (): Promise<string[]> => {
    ...
    const response = await fetch('https://engine.eduformacije.com/api/v1/srednje-skole/zupanije', {
      method: 'GET',
      headers: {
    ...
    if (!response.ok) {
      throw new Error('Greška prilikom dohvaćanja podataka o županijama');
    }
